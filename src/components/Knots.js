...
const Knots = () => {
    ...
    const Gif = () => (
        <div className="gifDiv">
            <img alt='gif' src='https://media.giphy.com/media/I5yH9Aeq0EGCA/giphy.gif'/>
        </div>
    )
    ...
    return (
        <>
            <div className="knotDiv">
                    <button className="grow"><Link className="f6" to='/climbing-knots/alpine-butterfly-bend'>Alpine Buttefly Bend</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/alpine-butterfly-loop'>Alpine Butterfly Loop</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/blakes-hitch'>Blake's Hitch</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/bowline'>Bowline</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/double-fishermans-knot'>Double Fisherman's Bend</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/figure-8-bend'>Figure-8 Bend</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/double-overhand-stopper'>Double Overhand Stopper</Link></button>
                    <button className="grow"><Link className="f6" to='/climbing-knots/figure-8-follow-through-loop'>Figure-8 Follow Through Loop</Link></button>
            </div>
            <Routes>
